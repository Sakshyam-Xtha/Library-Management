...
$topbarRole = 'admin';
$footerSearchAction = "location.href='admin-notifications.php'";
$extraCss = <<<'CSS'
...
<main class="content">
  ...
  <div class="under-construction">
    ...
    <p class="uc-sub">
      The admin notifications panel is being built. You'll be able to send announcements,
      manage member alerts, and monitor system notifications from here.
    </p>
    <div class="uc-dots">
